...
#feature-info  Distant Pixels Studio v1.0 - Linear processing pipeline for astrophotography.
...
function PipelineDialog()
{
   ...
   this.windowTitle = "Distant Pixels Studio v1.0";
